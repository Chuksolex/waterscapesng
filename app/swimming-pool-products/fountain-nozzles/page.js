...
import {fountainNozzleData} from "@/components/data/Data";
import styles from "./FountainNozzles.module.css";



const FountainNozzles = () => {
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.rowContainer}>
        {fountainNozzleData.map((product) => (
...
export default FountainNozzles;
